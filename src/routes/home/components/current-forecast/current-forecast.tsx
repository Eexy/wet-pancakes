...
import { CurrentForecastCard } from "./current-forecast-card/current-forecast-card.tsx";
import { CurrentForecastInfos } from "./current-forecast-infos/current-forecast-infos.tsx";
